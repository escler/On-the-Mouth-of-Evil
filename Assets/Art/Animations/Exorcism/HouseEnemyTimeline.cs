...
public class HouseEnemyTimeline : Enemy
{
    ...
    //    TimelineAsset timeline = Resources.Load<TimelineAsset>("Timelines/Exorcism");
    //    if (timeline == null)
    //    {
    //        Debug.LogError("Timeline 'Exorcism' not found.");
    //        yield break;
    //    }

    //    if (TimelineManager.Instance == null)
    //    {
    //        Debug.LogError("TimelineManager.Instance is null.");
    //        yield break;
    //    }
    //    enemyVisibility += 7.8f;
    //    enemyMaterial.SetFloat("_Power", enemyVisibility);
    //    activateExorcism = true;
    //    TimelineManager.Instance.PlayTimeline(timeline);
    //    PlayableDirector director = TimelineManager.Instance.GetPlayableDirector();
